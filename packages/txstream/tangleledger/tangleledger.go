...
func New() *TangleLedger {
	...
	messagelayer.Tangle().LedgerState.UTXODAG.GetEvents().TransactionConfirmed.Attach(t.txConfirmedClosure)
...
func (t *TangleLedger) Detach() {
	messagelayer.Tangle().LedgerState.UTXODAG.GetEvents().TransactionConfirmed.Detach(t.txConfirmedClosure)
