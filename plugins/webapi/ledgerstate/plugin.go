...
func configure(*node.Plugin) {
	...
	messagelayer.Tangle().LedgerState.UTXODAG.GetEvents().TransactionConfirmed.Attach(onTransactionConfirmedClosure)
...
func worker(shutdownSignal <-chan struct{}) {
	...
	messagelayer.Tangle().LedgerState.UTXODAG.GetEvents().TransactionConfirmed.Detach(onTransactionConfirmedClosure)
}
